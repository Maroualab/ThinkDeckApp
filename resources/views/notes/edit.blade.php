...
<head>
    ...
    <title>Edit Note - ThinkDeck</title>
...
<body class="bg-white text-gray-900 min-h-screen">
    <div class="max-w-3xl mx-auto px-4 py-8">
        <div class="flex items-center mb-6">
            <a href="{{ route('notes.show', $note) }}" class="text-gray-500 hover:text-gray-700 mr-4">
        ...
        <form action="{{ route('notes.update', $note) }}" method="POST">
            ...
            <div class="mb-4">
                <div class="flex items-center mb-2">
                    ...
                    <input type="text" name="icon" id="icon" class="w-12 px-2 py-1 border border-gray-300 rounded" value="{{ old('icon', $note->icon) }}">
                </div>
                <input 
                    type="text" 
                    name="title" 
            ...
            <div class="flex justify-end">
                <a href="{{ route('notes.show', $note) }}" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded text-sm font-medium transition-all mr-2">
                    Cancel
                </a>
