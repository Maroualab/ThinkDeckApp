        ...
        <div class="flex flex-col lg:flex-row lg:justify-between lg:items-start"> {{-- Changed items-center to items-start --}}
            ...
            <div class="flex flex-wrap gap-2 justify-start lg:justify-end"> {{-- Added justify-start/end --}}
                ...
                @if(session('active_workspace_id') != $workspace->id)
                    <a href="{{ route('workspaces.switch', $workspace) }}" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-all flex items-center text-sm font-medium" title="Switch to this workspace">
                ...
                @else
                     <span class="px-4 py-2 bg-indigo-100 text-indigo-700 rounded-md flex items-center text-sm font-medium" title="Current active workspace">
